The aiida-koopmans plugin for `AiiDA`_
=====================================================

``aiida-koopmans`` is available at http://github.com/mikibonacci/aiida-koopmans
...
.. toctree::
   ...
   API documentation <apidoc/aiida_koopmans>
...
``aiida-koopmans`` is released under the MIT license.
